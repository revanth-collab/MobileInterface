    ...
    useEffect(() => {
        setTimeout(() => {
            ...
            const dummyfeaturedData=[{
                ...
                "title":"Oasis Salon Haven",  
                "description":"Oasis Salon Haven is a luxurious spa retreat offering a range of rejuvenating treatments and therapies.",
                "category":"Salon",
                "rating":4.5,
                "distance":"2.5 km",
            ...
            },
            {
                ...
                "description":"Serenity Wellness Center is a holistic wellness center providing Salon, yoga, and wellness services.",
                "category":"Salon",
                "rating":4.8,
                "distance":"3.0 km",
        ...
        <Container fluid className="spa-page p-4">
            ...
            <Row className="gap-3 pb-3">
                ...
                <Col xs='auto' className="spa-reload-container">
                    <h1 className="spa-reload-content">SALON</h1>
            ...
            <Row>
                <Col xs={12} className="featured-section-top-container">
                    <h1 className="upcoming-heading">Premium Salon</h1>
                    <div className="featured-section-view-all align-items-center">
                        <h2 className="featured-view-all">View all</h2> 
                        <FaArrowRight className="featured-arrow" />
                    </div>
